  ...
  "inline-flex items-center rounded-full border border-slate-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:border-slate-800 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        one: "border-transparent bg-violet-300 text-violet-900",
        two: "border-transparent bg-pink-200 text-pink-900",
        three: "border-transparent bg-indigo-300 text-indigo-900",
        four: "border-transparent bg-purple-200 text-purple-900",
        five: "border-transparent bg-fuchsia-200 text-fuchsia-900",
      },
    },
    defaultVariants: {
      variant: "default",
